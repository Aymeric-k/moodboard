...
function AddWorkCardComponent({ moods }: AddWorkCardProps) {
  ...
  if (!isExpanded) {
    return (
      <motion.div
        ...
        className="add-work-card w-72 h-[420px] bg-slate-800/50 border-4 border-dashed border-slate-600 rounded-lg flex items-center justify-center cursor-pointer hover:bg-slate-800/80 hover:border-slate-500 transition-colors"
      >
  ...
  return (
    <motion.div
      layout
      className="add-work-card w-72 bg-slate-800 rounded-lg shadow-xl flex flex-col overflow-hidden border-4 border-dashed border-slate-600 transition-all duration-300 hover:border-slate-500 hover:bg-slate-750"
...
export default memo(AddWorkCardComponent);
